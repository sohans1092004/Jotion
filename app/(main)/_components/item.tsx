...
export const Item = ({
  ...
  return (
    <div
      ...
      className={cn(
        "group min-h-[27px] text-xl py-1 pr-3 w-full hover:bg-primary/5 flex items-center text-muted-foreground font-medium",
    ...
    >
      ...
      {documentIcon ? (
        <div className="shrink-0 h-[18-px] mr-2">{documentIcon}</div>
      ) : (
